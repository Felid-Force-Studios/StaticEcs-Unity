...
namespace FFS.Libraries.StaticEcs.Unity
{
...
#endif
    public abstract class MouseDragEntityProvider<TWorld> : UnityEntityEventProvider<TWorld>
        where TWorld : struct, IWorldType {

        [MethodImpl(AggressiveInlining)]
        protected virtual void OnMouseDragEvent() {
            World<TWorld>.SendEvent(new MouseDragEntityEvent {
                Ref = gameObject,
                EntityGID = EntityGID,
            });
        }
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
#endif
    public abstract class MouseDragEntityGIDProvider<TWorld> : MouseDragEntityProvider<TWorld>
        where TWorld : struct, IWorldType {
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
#endif
    public abstract class MouseDragEntityRefProvider<TWorld, TProvider> : MouseDragEntityProvider<TWorld>
        where TWorld : struct, IWorldType
